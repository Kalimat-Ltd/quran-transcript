...
class MoshafAttributes(BaseModel):
    ...
    yaa_ataan: Literal["wasl", "hadhf", "ithbat"] = Field(
        ...
        field_arabic_attrs_map={"wasl": "وصل", "hadhf": "حذف", "ithbat": "إثبات"},
    ...
    yalhath_dhalik: Literal["izhar", "idgham", "waqf"] = Field(
        ...
        field_arabic_attrs_map={"izhar": "إظهار", "idgham": "إدغام", "waqf": "وقف"},
    ...
    alif_salasila: Literal["hadhf", "ithbat", "wasl"] = Field(
        ...
        field_arabic_attrs_map={"hadhf": "حذف", "ithbat": "إثبات", "wasl": "وصل"},
    ...
    raa_firq: Literal["waqf", "tafkheem", "tarqeeq"] = Field(
        ...
        field_arabic_attrs_map={"waqf": "وقف", "tafkheem": "تفخيم", "tarqeeq": "ترقيق"},
    ...
    raa_alqitr: Literal["wasl", "tafkheem", "tarqeeq"] = Field(
        ...
        field_arabic_attrs_map={"wasl": "وصل", "tafkheem": "تفخيم", "tarqeeq": "ترقيق"},
